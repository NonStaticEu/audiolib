...
Each implementation of AudioInfoSupplier returns a dedicated info file (eg: FlacInfo for FlacInfoSupplier#getInfos) containing format-specific preoperties,
