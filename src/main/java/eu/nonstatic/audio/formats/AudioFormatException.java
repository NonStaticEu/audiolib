...
import eu.nonstatic.audio.AudioException;
...
public class AudioFormatException extends AudioException {
  ...
  public AudioFormatException(String name, long location, AudioFileType type, String message) {
    super(name, message);
    this.location = location;
    this.type = type;
  }

  public AudioFormatException(String name, long location, AudioFileType type, String message, Throwable cause) {
