...
class AudoInfoSuppliersTest {
  ...
  void should_not_select_supplier_by_extension() {
    ...
    assertEquals("No AudioFileType available for extension: null", iae2.getMessage());
  }
}
